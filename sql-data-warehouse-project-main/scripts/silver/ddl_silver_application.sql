...
/*
===============================================================================
DDL Script: Create Silver Application Tables
===============================================================================
Script Purpose:
    Creates cleaned and typed silver tables for Home Credit application data.

Silver Layer Responsibilities:
    - Convert raw text columns into proper datatypes
    - Standardize categorical values
    - Preserve important financial and risk-related fields
    - Add audit column
===============================================================================
*/

DROP TABLE IF EXISTS silver.application_train;
GO
